...
const SearchBox = () => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-xl p-4 md:p-6">
      <form onSubmit={handleSubmit} className="flex flex-col md:flex-row md:items-center md:justify-center">
        <div className="flex flex-col flex-grow mb-4 md:mb-0 md:mr-4">
          ...
          <input 
            ...
            className="px-4 py-3 border border-neutral-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-gray-800"
            value={searchQuery}
